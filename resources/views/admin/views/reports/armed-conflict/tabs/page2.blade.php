...
<label><b>NUMBER OF AFFECTED LEARNERS AND PERSONNEL
...
<input type="number" name=" kinder_Learners with Disabilities" class="form-control" placeholder="Learners with Disabilities" required value="{{$report->data->{'kinder_Learners_with_Disabilities'} ?? ''}}"><br>
...
<input type="input" name=" Grade1_Learners with Disabilities" class="form-control" placeholder="Learners with Disabilities" required value="{{$report->data->{'Grade1_Learners_with_Disabilities'} ?? ''}}"><br>
...
<input type="input" name=" Grade2_Learners with Disabilities" class="form-control" placeholder="Learners with Disabilities" required value="{{$report->data->{'Grade2_Learners_with_Disabilities'} ?? ''}}">
<br>
<hr />