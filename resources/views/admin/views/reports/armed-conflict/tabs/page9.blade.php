...
<input type="input" name="  Division Affected" class="form-control" value="{{$report->data->{'Division_Affected'} ?? ''}}"><br>

<label>Region</label><br>
<input type="input" name="  Region Affected" class="form-control" value="{{$report->data->{'Region_Affected'} ?? ''}}"><br>

<label>EXTERNAL PARTNERS
  (e.g. NGOs, CSOs)</label><br>
<input type="input" name="EXTERNAL PARTNERS" class="form-control" value="{{$report->data->{'EXTERNAL_PARTNERS'} ?? ''}}"><br>
...
<input type="input" name="OTHER CONCERNS" class="form-control" value="{{$report->data->{'OTHER_CONCERNS'} ?? ''}}" ><br>
<br>
<hr>