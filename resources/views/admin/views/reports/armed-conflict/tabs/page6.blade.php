...
<br>
<p><b>Grade Level </b></p>
<input type="number" name="totally-damaged" class="form-control" value="">
<hr />
...
<input type="number" name="major-damage" class="form-control" value="">

<label>b. No. of Damaged School Furniture</label><br>

<label>Arm
  Chairs</label><br>
<input type="number" name=" decreased-DepEd-teaching " class="form-control" value="">

<label>Desks</label><br>
<input type="number" name=" injured-DepEd-teaching" class="form-control" value="">

<label>Teacher's
  Tables</label><br>
<input type="number" name="displaced-DepEd-teaching" class="form-control" value="">
