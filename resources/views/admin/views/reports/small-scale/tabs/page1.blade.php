<h5><b>PROVINCE</b></h5>
<input type="input " name="province" class="form-control" placeholder="PROVINCE" value="">

<h5><b>Municipality</b></h5>
<input type="input" name="municipality" class="form-control" placeholder="Municipality" value="">

<h5><b>Barangay</b></h5>
<input type="input" name="barangay" class="form-control" placeholder="Barangay" value="">
