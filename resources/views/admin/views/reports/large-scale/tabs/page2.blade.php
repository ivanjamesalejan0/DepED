...
<input type="number" name= "damaged-school" class="form-control" value="">
<br>
<hr />
...
<input type="number" name= "academic-classrooms" class="form-control" value="">
<br>
<hr />
...
assessment to respective DepEd offices for proper intervention)</label><br>
<input type="number" name= "academic-classrooms" class="form-control" value="" >
<br>