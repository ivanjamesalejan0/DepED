...
<body bgcolor="#A0A0A0" vlink="blue" link="blue">
	<div id="page1-div" style="position:relative;width:892px;height:1261px;">
		...
		<p style="position:absolute;top:43px;left:714px;white-space:nowrap" class="ft12">Typhoon&#160;Odette</p>
		<p style="position:absolute;top:168px;left:123px;white-space:nowrap" class="ft16">
			{{$report->data->{'EBEIS'} ?? ''}}<br />Airport&#160;Village&#160;ES</p>
...
<body bgcolor="#A0A0A0" vlink="blue" link="blue">
	<div id="page2-div" style="position:relative;width:892px;height:1261px;">
		<img width="892" height="1261" src="{{ asset('theme/img/target002.png') }}" alt="background image" />
	</div>
</body>
